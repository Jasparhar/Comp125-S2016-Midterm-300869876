...
if(IntroParagraph)
{
    IntroParagraph.textContent=IntroParagraph[0];
};
if(Folegandros){
    Folegandros.textContent=Folegandro[0];
};
if(Alonissos){
    Alonissos.textContent=Alonisso[0];
};

if(Amorgos)
{
    Amorgos.textContent=Amorgo[0]; 
};
if(Spetses){
    Spetses.textContent=Spetse[0];
};

if(Syros){
    Syros.textContent=Syro[0];
};
if(Milos){
    Milos.textContent=Milo[0];
};
if(Hydra){
    Hydra.textContent=Hydr[0];
};
if(Ithaca){
    Ithaca.textContent=Ithac[0];
};
if(Gavdos){
    Gavdos.textContent=Gavdo[0];
};
